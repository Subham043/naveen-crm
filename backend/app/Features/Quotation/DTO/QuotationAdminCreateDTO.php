...
final class QuotationAdminCreateDTO
{
     ...
     * @return self
     */
    public static function fromRequest(QuotationAdminCreateRequests $request): self
    {
        return new self(
            name: $request->validated('name'),
            email: $request->validated('email'),
            is_active: QuotationStatus::Pending->value(),
            quotation_sent: $request->validated('quotation_sent'),
            lead_source: LeadSource::Call->value(),
    ...
    /**
     * @extends \Illuminate\Support\Collection<int, QuotationAdminCreateDTO>
     */
