...
class ServiceTeamOrderService extends AbstractService
{
    ...
    {
        return Order::select('id', 'quotation_id', 'payment_status', 'payment_card_type', 'payment_gateway', 'transaction_id', 'yard_located', 'tracking_details', 'order_status', 'created_at', 'updated_at')
            ->with([
