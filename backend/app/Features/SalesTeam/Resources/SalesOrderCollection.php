...
class SalesOrderCollection extends JsonResource
{
	...
	public function toArray($request)
	{
		return [
			...
			'sales_user_info' => $this->sales_user_id ? SalesOrderUserCollection::make($this->salesUser) : null,
			...
			'approval_by_info' => $this->approval_by_id ? SalesOrderUserCollection::make($this->approvalBy) : null,
