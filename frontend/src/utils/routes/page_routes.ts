...
export const page_routes = {
  ...
  sales_team_performance_report: { link: "/sales/reports/sales-performance", name: "Sales Performance Report" },
  sales_team_lead_source_report: { link: "/sales/reports/sales-lead-source-performance", name: "Lead Source Performance Report" },
  ...
  sales_team_profitability_per_quotation_report: { link: "/sales/reports/profitability-per-quotation", name: "Profitability Per Quotation Report" },
