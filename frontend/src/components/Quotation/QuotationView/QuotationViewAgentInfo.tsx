...
type Props = {
  sales_user_info: QuotationType["sales_user_info"];
  is_created_by_agent: QuotationType["is_created_by_agent"];
  assigned_at: QuotationType["assigned_at"];
};

function QuotationViewAgentInfo({
  sales_user_info,
  is_created_by_agent,
  assigned_at,
}: Props) {
...
export default QuotationViewAgentInfo;
