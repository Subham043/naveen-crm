  ...
  useEffect(() => {
    ...
    if (modal.type === "update" && data) {
      form.reset({
        ...
        part_warranty: data.quotation_info && data.quotation_info.part_warranty !== undefined ? data.quotation_info.part_warranty : 1,
        part_vin: data.quotation_info && data.quotation_info.part_vin ? data.quotation_info.part_vin : "",
