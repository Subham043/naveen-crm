...
type Props = {
  sales_user_info: SalesOrderType["sales_user_info"];
  is_created_by_agent: SalesOrderType["is_created_by_agent"];
  assigned_at: SalesOrderType["assigned_at"];
};

function SalesOrderAgentInfo({
  sales_user_info,
  is_created_by_agent,
  assigned_at,
}: Props) {
...
export default SalesOrderAgentInfo;
